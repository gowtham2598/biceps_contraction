...
# 1. Define our parameter configurations and folder structural paths
c4_values = ["30.0", "61.44", "90.0"]
feb_input_dir = "feb_inputs/fiber_stiffness_c4"
log_dir = "raw_logs/fiber_stiffness_c4"
plot_dir = "febio_results/fiber_stiffness_c4"
...
print("="*70)
print("LAUNCHING AUTOMATED COUPLING LOOP: EXPONENT SHAPE SWEEP (c4)")
print("="*70)

for v in c4_values:
    input_filename = f"biceps_c4_{v}.feb"
    ...
    if process.returncode == 0:
        ...
        disp_file = os.path.join(log_dir, f"c4_{v}_disp.txt")
        stress_file = os.path.join(log_dir, f"c4_{v}_stress.txt")
        vol_file = os.path.join(log_dir, f"c4_{v}_vol.txt")
